...
const SeatLayout = () => {
  ...
  const handleSeatClick = (seatId) => {
    ...
    if (occupiedSeats.includes(seatId)) {
      return toast("This seat is already booked. Please select another seat.");
    }
  ...
  const bookTickets = async () => {
    try {
      ...
      if (!selectedTime || !selectedSeats.length)
        return toast.error("Please select a show time and seats");
  ...
  return show ? (
    <div className="flex flex-col md:flex-row w-full min-h-screen px-6 md:px-10 lg:px-20 pt-32">
      {/* Available Timings */}
      ...
      {/* Seat Layout */}
      <div className="relative flex-1 flex flex-col items-center w-full max-md:mt-16">
        <BlurCircle top="-100px" left="-100px" />
        <BlurCircle top="0" left="0" />
        <h1 className="text-2xl font-semibold mb-4">Select Your seat</h1>

        {/* Scrollable Seat Wrapper */}
